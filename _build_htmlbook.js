...
const gpCss = `
  ...
  #gp .stage{flex:1;min-height:0;overflow-y:auto;padding:28px 30px 40px;background:#EFEBE7}
  ...
  #gp .cut{position:absolute;left:0;top:0;overflow:hidden;transform-origin:0 0}
...
(function(){
  ...
  function open(pageKey, col){
    ...
    g.part.forEach(function(p, i){ var b = document.createElement("button"); b.type = "button"; b.textContent = p[0];
      b.addEventListener("click", function(){ k = i; build(); }); steps.appendChild(b); });
  ...
  addEventListener("resize", function(){ if (cur) build(); });
  window.gpOpen = open;
})();
</script>
`;
