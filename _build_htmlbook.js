...
out = out.replace("</body>", fitJs + "</body>");
...
console.log(`${outFile}: ${pages.length} sahifa, ${pages.reduce((a, p) => a + p.runs.length, 0)} ta matn bo'lagi, ${(out.length / 1024).toFixed(0)} KB`);
